    ...
    for (let i = 0; i < data.length; i++) {
      ...
      if (Array.isArray(row)) {
        ...
        entry = {
          ...
          discount: String(row[14] || ''),
          ewayBill: String(row[15] || ''),
          invoiceNoValue: String(row[16] || ''),
          inTime: String(row[17] || ''),
        ...
        entry = {
          ...
          discount: getRowValue(row, ['discount', 'disc', 'discountamount', 'discountval']),
